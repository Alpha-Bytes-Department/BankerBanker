...
export default function Footer() {
  return (
    <footer className="bg-[#000000] py-12 px-4 lg:px-6 font-inter border-t border-gray-200">
      <div className="mx-auto w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-[#FFFFFF]">Legal</h3>
          <ul className="space-y-3">
            <li>
              <a
                href="#"
      ...
      <div className="text-center text-[#9CA3AF] text-sm pt-10 mt-10 border-gray-200">
        <p>
          &copy; {new Date().getFullYear()} BANCRE CORPORATION. All rights
          reserved.
        </p>
      </div>
    </footer>
