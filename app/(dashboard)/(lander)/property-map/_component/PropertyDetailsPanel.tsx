  ...
  if (!property) {
    return (
      <div className="flex flex-col items-center justify-center text-center p-8">
        ...
        <h3 className="text-base text-gray-900 mb-2">Select a Property</h3>
  ...
  return (
    <div className="flex flex-col bg-white overflow-hidden">
      ...
      <div className="flex-1 p-4">
        {/* ====== Property Name ====== */}
        <h2 className="text-lg text-gray-900 mb-2">{property.propertyName}</h2>
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-1">Requested Loan Amount</p>
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition-colors"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm hover:bg-gray-50 transition-colors"
          >
