    ...
    <div className="mb-4 md:mb-6 space-y-3 md:space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 md:pl-12 pr-4 py-2.5 md:py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm md:text-base"
        />
      </div>
