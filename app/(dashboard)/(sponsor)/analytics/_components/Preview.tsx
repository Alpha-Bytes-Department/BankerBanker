        ...
        <div className="flex flex-col gap-5 p-5 flex-1 border border-[#0000001A] rounded-lg h-[90vh]">
            <div className="flex items-center justify-between">
                <div className="flex gap-2">
                    <FileText/>
                    <h1>Financial_Statements_Q3_2024.pdf</h1>
                </div>
                <button className='cursor-pointer flex gap-2 border border-[#0000001A] px-3 py-1 rounded-full'><Download /> <span>Download</span> </button>
            </div>
